...
export default function SupplyPage() {
  return (
    <main id="main-content">
      ...
      <section className="section"><div className="container"><div className="section-heading narrow-heading"><div><p className="kicker">Процесс поставки</p><h2>Четыре шага до согласованной партии</h2></div></div><div className="supply-timeline"><article><span>01</span><ClipboardList /><div><h3>Получаем требования</h3><p>Фиксируем материал или назначение детали, размеры, количество, условия эксплуатации и желаемый срок.</p></div></article><article><span>02</span><Boxes /><div><h3>Подбираем марку</h3><p>Сравниваем базовые и наполненные исполнения, проверяем ограничения и задаём уточняющие вопросы.</p></div></article><article><span>03</span><FileCheck2 /><div><h3>Проверяем партию</h3><p>Уточняем производителя, доступность, форму заготовки, технические данные и фактически доступные документы.</p></div></article><article><span>04</span><PackageCheck /><div><h3>Фиксируем предложение</h3><p>Согласовываем точную позицию, количество, стоимость, срок, упаковку и маршрут доставки до оплаты.</p></div></article></div></div></section>
